...
function draw() {
	...
	image(moon, 500, 100, 100, 100);

	// loop

	for (let x = 0; x < width; x += 125) {
		image(pinetreeblack, x + 25, 450);
		image(pinetreeblack, x + 100, 450);
		image(pinetreedark, x + 62.5, 450);
		image(pinetree, x, 450);
	}
